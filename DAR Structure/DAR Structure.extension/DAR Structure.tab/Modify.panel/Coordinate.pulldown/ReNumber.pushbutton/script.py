...
# -----------------------------
# Renumber tool starting point
# -----------------------------
if isinstance(revit.active_view, (DB.View3D, DB.ViewPlan, DB.ViewSection, DB.ViewSheet)):
    # prepare options
    renumber_options = [
        RNOpts(cat=BIC.OST_StructuralFoundation),  # Structural Foundations
        RNOpts(cat=BIC.OST_StructuralColumns)      # Structural Columns
    ]
    ...
    forms.alert('Active view must be either a Plan, 3D, Section or Sheet view.')
